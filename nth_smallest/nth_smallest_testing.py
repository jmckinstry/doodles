...
#print("Input:\t\t" + str(list_input) + ", size " + str(len(list_input)) + ", seeking smallest(" + str(nth_smallest) + ")")
...
def f_nth_smallest(a, n, pivot = -1):
        ...
        if len(list_left) == (n - 1): # Pivot won
                ...
                #print("\t\t\tRecursing left with " + str(list_left) + ", " + str(n))
                return f_nth_smallest(list_left, n)
        else: # Winner is in right
                #print("\t\t\tRecursing right with " + str(list_right) + ", " + str(n - (len(list_left) + 1)))
...
print("Solution 2:\tSmallest(" + str(nth_smallest) + ") value: " + str(val) + ", cost: " + str(cost))
